...
@Component({
  selector: 'app-grille-tarifaire-paiement-facture',
  templateUrl: './grille-tarifaire-paiement-facture.component.html',
  styleUrls: ['./grille-tarifaire-paiement-facture.component.css']
})
export class GrilleTarifairePaiementFactureComponent {
  ...
  open_export_dialog() {
    const export_dialog = this.dialog.open(ExportComponent, {
      data: { title: "des grilles tarifaire de paiement des factures" }
    });
